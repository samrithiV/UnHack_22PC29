...
metaFile = 'D:\\UnHack 22PC29\\1st\\metadata.csv'
careFile = 'D:\\UnHack 22PC29\\1st\\CareAreas.csv'
metaData = []
careAreas = []
...
with open('D:\\UnHack 22PC29\\1st\\mainField.csv','w+',newline='') as file:
    writer_obj = writer(file)
    writer_obj.writerows(mainFields)

with open('D:\\UnHack 22PC29\\1st\\subField.csv','w+',newline='') as file:
    writer_obj = writer(file)
